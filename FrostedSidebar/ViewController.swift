...
class ViewController: UIViewController, FrostedSidebarDelegate {
	...
	@IBAction func onBurger() {
        if !frostedSidebar{
            ...
            frostedSidebar = FrostedSidebar(itemImages: images, colors: colors, selectedItemIndices: NSIndexSet())
//            frostedSidebar = FrostedSidebar(itemImages: images, colors: nil, selectedItemIndices: NSIndexSet())
